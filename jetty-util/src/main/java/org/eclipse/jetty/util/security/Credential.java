    ...
    public static class MD5 extends Credential
    {
        ...
        public boolean check(Object credentials)
        {
            try
            {
                ...
                if (credentials instanceof MD5 || credentials instanceof Password || credentials instanceof String)
                {
                    byte[] digest = null;
                    ...
                    if (credentials instanceof MD5) {
                        ...
                        synchronized (__md5Lock)
                        {
                            ...
                            __md.reset();
                            __md.update(credentials.toString().getBytes(StandardCharsets.UTF_8));
                            digest = __md.digest();
                        }
                    }
